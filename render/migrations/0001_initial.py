    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adicionado_por', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_add_by', to=settings.AUTH_USER_MODEL)),
                ('despacho_cigt', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_despacho_cigt', to='render.despachocigtplanotrabalho')),
                ('membro_cigt', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_membro_cigt', to='render.comissaointerna')),
                ('modificado_por', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_change_by', to=settings.AUTH_USER_MODEL)),
                ('modelo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_modelo', to='render.modelodocumento')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modelo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_modelo', to='render.modelodocumento')),
                ('posto_trabalho', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_posto_trabalho_servidor', to='render.postostrabalho')),
                ('posto_trabalho_chefia', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_posto_trabalho_chefia', to='render.postostrabalho')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cumprimento', models.CharField(blank=True, choices=[('cumprida', 'Cumprida'), ('parcialmente_cumprida', 'Parcialmente Cumprida'), ('nao_executada', 'Não Cumprida')], max_length=36, null=True)),
                ('justificativa_nao_cumprimento', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('servidor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_servidor', to=settings.AUTH_USER_MODEL)),
                ('posto_trabalho', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_posto_trabalho', to='render.postostrabalho')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cargo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_cargo', to='render.cargo')),
        ...
        migrations.AddField(
            model_name='setor',
            name='unidade',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_unidade', to='render.unidade'),
        ),
        migrations.CreateModel(
